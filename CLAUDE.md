...
This project is indexed by GitNexus as **DexReader** (2240 symbols, 3562 relationships, 0 execution
...
2. `gitnexus_context({name: "<suspect function>"})` — see all callers, callees, and process
   participation
3. `READ gitnexus://repo/DexReader/process/{processName}` — trace the full execution flow step by
   step
