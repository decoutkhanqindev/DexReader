...
sealed class UserError(@param:StringRes val messageRes: Int) {
  sealed class EmailError(@StringRes message: Int) : UserError(message) {
  ...
  sealed class PasswordError(@StringRes message: Int) : UserError(message) {
  ...
  sealed class ConfirmPasswordError(@StringRes message: Int) : UserError(message) {
  ...
  sealed class NameError(@StringRes message: Int) : UserError(message) {
    data object Required : NameError(R.string.name_required)
  }

  data object UserNotFoundError : UserError(R.string.error_user_not_found)
}
