...
sealed class UserUiError(@param:StringRes val messageRes: Int) {
  sealed class Email(@StringRes messageRes: Int) : UserUiError(messageRes) {
  ...
  sealed class Password(@StringRes messageRes: Int) : UserUiError(messageRes) {
  ...
  sealed class ConfirmPassword(@StringRes messageRes: Int) : UserUiError(messageRes) {
  ...
  sealed class Name(@StringRes messageRes: Int) : UserUiError(messageRes) {
    data object Required : Name(R.string.name_required)
  }

  data object NotFound : UserUiError(R.string.error_user_not_found)
  data object RegistrationFailed : UserUiError(R.string.oops_something_went_wrong_please_try_again)
}
